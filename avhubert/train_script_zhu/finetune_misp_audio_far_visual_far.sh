...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq/fairseq_cli/hydra_train.py \
       ...
       model.w2v_path=/apdcephfs/share_1316500/qiushizhu/av_results/pretrain_misp_1_8ngpu_4updatefreq/checkpoints/checkpoint_last.pt \
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_near_a_1_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
