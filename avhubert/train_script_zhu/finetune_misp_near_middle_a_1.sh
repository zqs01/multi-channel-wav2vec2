...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq/fairseq_cli/hydra_train.py \
       ...
       task.data=/apdcephfs/share_1316500/qiushizhu/misp_related/misp_tsv_new/visual_audio_bpe/audio_near_middle_visual_middle \
       task.label_dir=/apdcephfs/share_1316500/qiushizhu/misp_related/misp_tsv_new/visual_audio_bpe/audio_near_middle_visual_middle \
       ...
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_near_middle_a_1_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
