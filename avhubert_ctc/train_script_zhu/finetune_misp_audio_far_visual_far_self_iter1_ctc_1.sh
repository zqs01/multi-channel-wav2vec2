...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq/fairseq_cli/hydra_train.py \
       ...
       model.w2v_path=/apdcephfs/private_qiushizhu/av_results/pretrain_fbank_iter1_16ngpu_1updatefreq/checkpoints/checkpoint_last.pt \
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_audio_far_visual_far_self_iter1_ctc_1_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
