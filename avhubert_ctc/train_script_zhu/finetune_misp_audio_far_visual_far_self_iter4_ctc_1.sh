...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq2/fairseq_cli/hydra_train.py \
       ...
       model.w2v_path=/apdcephfs/share_1316500/qiushizhu/av_results/pretrain_avhubert_iter4_32ngpu_1updatefreq/checkpoints/checkpoint_last.pt \
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_audio_far_visual_far_self_iter4_ctc_1_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
