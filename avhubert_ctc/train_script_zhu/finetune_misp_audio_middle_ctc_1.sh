...
mkdir -p /checkpoint/bshi/data/lrs3//video/hubert/stitch-iters/envox-iter4-l12c2000/
cd /checkpoint/bshi/data/lrs3//video/hubert/stitch-iters/envox-iter4-l12c2000/ && touch dict.km.txt
...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq/fairseq_cli/hydra_train.py \
       ...
       task.data=/apdcephfs/share_1316500/qiushizhu/misp_related/misp_tsv_new/visual_audio/audio_middle_visual_far \
       task.label_dir=/apdcephfs/share_1316500/qiushizhu/misp_related/misp_tsv_new/visual_audio/audio_middle_visual_far \
       model.w2v_path=/apdcephfs/share_1316500/qiushizhu/av_results/base_vox_iter5.pt \
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_audio_middle_ctc_1_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
