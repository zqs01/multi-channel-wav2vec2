...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq2/fairseq_cli/hydra_train.py \
       ...
       model.w2v_path=/apdcephfs/share_1316500/qiushizhu/av_results/pretrain_fbank_iter1_16ngpu_1updatefreq/checkpoints/checkpoint_last.pt \
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_audio_near_visual_middle_self_iter1_ctc_1_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
