...
python3  /apdcephfs/private_qiushizhu/av_hubert/fairseq/fairseq_cli/hydra_train.py \
       ...
       hydra.run.dir=/apdcephfs/share_1316500/qiushizhu/av_results/finetune_misp_near_a_ctc_2_${ngpu}ngpu_${updatefreq}updatefreq \
       common.user_dir=`pwd` \
       ...
       lr_scheduler.warmup_steps=15000 \
