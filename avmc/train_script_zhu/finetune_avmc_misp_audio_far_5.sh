...
ngpu=$1
updatefreq=$2
model_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/finetune_avmc_misp_audio_far_5_ngpu${ngpu}_updatefreq${updatefreq}
...
python3 /apdcephfs/private_qiushizhu/avmc/fairseq2/fairseq_cli/hydra_train.py \
       ...
       model.mask_prob=0.6 \
       lr_scheduler.phase_ratio=[0.3,0.3,0.4] \
