...
ngpu=$1
updatefreq=$2
model_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/finetune_avmc_misp_audio_far_visual_far_3_ngpu${ngpu}_updatefreq${updatefreq}
