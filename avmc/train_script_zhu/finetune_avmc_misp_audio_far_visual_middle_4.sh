...
ngpu=$1
updatefreq=$2
model_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/finetune_avmc_misp_audio_far_visual_middle_4_ngpu${ngpu}_updatefreq${updatefreq}
...
python3 /apdcephfs/private_qiushizhu/avmc/fairseq/fairseq_cli/hydra_train.py \
       ...
       lr_scheduler.phase_ratio=[0.3,0.4,0.3] \
