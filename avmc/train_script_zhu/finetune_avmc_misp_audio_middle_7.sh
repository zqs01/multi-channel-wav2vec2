...
ngpu=$1
updatefreq=$2
model_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/finetune_avmc_misp_audio_middle_7_ngpu${ngpu}_updatefreq${updatefreq}
...
python3 /apdcephfs/private_qiushizhu/avmc/fairseq2/fairseq_cli/hydra_train.py \
       ...
       model.w2v_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/pretrain_avmc_misp_av_5_ngpu32_updatefreq1/checkpoint_last.pt \
       ...
       model.mask_prob=0.0 \
       lr_scheduler.phase_ratio=[0.4,0.3,0.3] \
