...
from .avmc_pretraining import AVMCPretrainingTask, AVMCPretrainingConfig
...
@dataclass
class AVMCFinetuningConfig(AVMCPretrainingConfig):
...
@register_task("avmc_finetuning", dataclass=AVMCFinetuningConfig)
class AVMCFinetuningTask(AVMCPretrainingTask):
    """ """

    cfg: AVMCFinetuningConfig
    ...
    def load_dataset(
        self, split: str, task_cfg: AVMCFinetuningConfig = None, **kwargs
    ):
