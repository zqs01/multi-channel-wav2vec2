...
from .avmc_dataset import BinarizedAudioDataset, AVMCDataset
...
@dataclass
class AVMCPretrainingConfig(FairseqDataclass):
...
@register_task("avmc_pretraining", dataclass=AVMCPretrainingConfig)
class AVMCPretrainingTask(FairseqTask):
    """ """

    cfg: AVMCPretrainingConfig

    @classmethod
    def setup_task(cls, cfg: AVMCPretrainingConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (AVMCPretrainingConfig): configuration of this task
        """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = AVMCDataset(
