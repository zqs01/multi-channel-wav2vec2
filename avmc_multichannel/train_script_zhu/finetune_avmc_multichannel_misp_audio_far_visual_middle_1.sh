...
ngpu=$1
updatefreq=$2
model_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/finetune_avmc_multichannel_misp_audio_far_visual_middle_1_ngpu${ngpu}_updatefreq${updatefreq}
...
python3 /apdcephfs/private_qiushizhu/avmc/fairseq2/fairseq_cli/hydra_train.py \
       ...
       task.data=/apdcephfs/share_1316500/qiushizhu/misp_related/misp_tsv_new/visual_audio/multichannel_tsv/audio_far_visual_middle \
       model.w2v_path=/apdcephfs/private_qiushizhu/avmc_results/pretrain_avmc_multichannel_misp_av_1_ngpu32_updatefreq1/checkpoint_1.pt \
