...
ngpu=$1
updatefreq=$2
model_path=/apdcephfs/share_1316500/qiushizhu/avmc_results/finetune_avmc_multichannel_misp_audio_near_1_ngpu${ngpu}_updatefreq${updatefreq}
...
python3 /apdcephfs/private_qiushizhu/avmc/fairseq2/fairseq_cli/hydra_train.py \
       ...
       task.data=/apdcephfs/share_1316500/qiushizhu/misp_related/misp_tsv_new/visual_audio/multichannel_tsv/audio_near_visual_far \
